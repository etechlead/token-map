...
1. Прочитай:
   ...
   - `docs/plan.md`
   - `docs/status.md`
2. Определи **первый незавершённый этап** из `docs/plan.md`.
3. Выполни **только этот этап**.
...
После каждого этапа обязательно добавить:
- дата/этап;
- что реализовано;
- что проверено;
- какие решения приняты;
- что отложено или осталось спорным.
